...
class r {
  constructor({ data: e, config: t, api: i, block: a, readOnly: n }) {
    ...
    s(this, "addImageIconSvg", '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20" aria-hidden="true"><path fill="#5C6B7A" fill-rule="nonzero" d="M20 17.778V2.222A2.222 2.222 0 0 0 17.778 0H2.222A2.222 2.222 0 0 0 0 2.222v15.556C0 19.006.994 20 2.222 20h15.556A2.222 2.222 0 0 0 20 17.778ZM6.111 11.667l2.778 3.339L12.778 10l5 6.667H2.222l3.89-5Z"/></svg>');
  ...
  get classes() {
    return {
      ...
      wrapperForLayoutType: (e) => `cdx-card-image--${e}`
    };
  }
  set data(e) {
    this._data = Object.assign({}, {
      ...
      layout: e.layout || r.DEFAULT_LAYOUT_TYPE,
  ...
  render() {
    ...
    if (e && (this.nodes.image = this.make("img", this.classes.image, {
      ...
      n.type = "file", n.accept = "image/*", n.style.display = "none", this.nodes.fileInput = n, this.nodes.fileButton = this.make("div", this.classes.fileButton, {
    ...
    }), this.nodes.description.dataset.placeholder = this.descriptionPlaceholder, this.nodes.contentContainer.appendChild(this.nodes.description), this.nodes.wrapper.appendChild(this.nodes.contentContainer), this.updateLayout(this._data.layout || r.DEFAULT_LAYOUT_TYPE), this.updateAlign(this._data.align || r.DEFAULT_ALIGN_TYPE), this.nodes.wrapper;
  }
  save() {
    var e, t;
    return {
  ...
  renderSettings() {
    const e = this.layouts.map((i) => ({
      ...
      label: i.title,
      toggle: "align",
      isActive: this._data.align === i.name,
      onActivate: () => {
        this.updateAlign(i.name);
      }
    }));
    return [...e, ...t];
  }
  ...
  updateLayout(e) {
    var t;
    this._data.layout === e && ((t = this.nodes.wrapper) == null ? void 0 : t.classList.contains(this.classes.wrapperForLayoutType(e))) || (this._data.layout = e, this.layouts.forEach((i) => {
      var a;
      (a = this.nodes.wrapper) == null || a.classList.toggle(this.classes.wrapperForLayoutType(i.name), this._data.layout === i.name);
    }));
  }
  updateAlign(e) {
    var t;
